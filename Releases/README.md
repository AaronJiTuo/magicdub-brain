...
- [MagicDub 项目总览](00_MagicDub项目总览.md)：当前仓库取舍、自用技能集主线、magicdub-cli 设计及历史 Web 背景。
- [magicdub-cli 系统设计](06_magicdub-cli系统设计.md)：本地 CLI 编排式 pipeline、状态／路径与 **v0.1.0 实现范围**（当前可开工的权威规范）。
- [magicdub-skills 项目规划](05_magicdub-skill项目规划.md)：2026-09-13 收敛的自用 Codex 技能集规范，包含三入口、候选模型、短视频优先与多人配音、强制对齐、费用、维护与验收要求；保留原文件路径供历史引用。
